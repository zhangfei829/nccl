...
if [[ "$enable_copy" == "1" ]]; then
  ...
  # V7 in-kernel INPUT_COPY (V5-A 4-warp same-warp) + chunk-gate sync
  # (inter_node_G2S writes SMEM gate at end, INPUT_COPY entry spin-waits
  # with nanosleep yield to release SM scheduler slot).
